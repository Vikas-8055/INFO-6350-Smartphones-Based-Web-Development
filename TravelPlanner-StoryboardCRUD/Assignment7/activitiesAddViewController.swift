...
class activitiesAddViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        trips = DataManager.shared.trips
    ...
    @IBAction func saveButtonTapped(_ sender: UIButton) {
        ...
        guard let activityIdText = activityIdTextField.text, let activityId = Int(activityIdText),
        ...
        if DataManager.shared.activities.contains(where: { $0.id == activityId }) {
