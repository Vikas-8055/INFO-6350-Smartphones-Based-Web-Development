...
class tripAddViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    var selectedDestinationId: Int32?
    ...
    override func viewDidLoad() {
        ...
        destinations = DataManager.shared.fetchDestinations() // Core Data
    ...
    @IBAction func saveButtonTapped(_ sender: UIButton) {
        guard let tripIdText = tripIdTextField.text,
              let tripId = Int32(tripIdText),
